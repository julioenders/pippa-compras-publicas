...
async def buscar_oportunidades(
    ...
    base_where = [
        ...
        Contratacao.uf == uf,
        or_(
            Contratacao.situacao.in_(["aberta", "futura", None]),
    ...
    for row in rows:
        ...
        oportunidades.append({
            ...
            "cota_reservada": bool(row.cota_reservada),
            ...
            "link_participacao": row.link_sistema_origem,
...
async def detalhar_oportunidade(
    ...
    itens = [
        {
            ...
            "material_ou_servico": it.material_ou_servico,
            "unidade": it.unidade,
            ...
            "ncm": it.ncm,
            "nbs": it.nbs,
            "beneficio_mpe": it.beneficio_mpe,
            "cota_reservada": it.cota_reservada,
        }
    ...
    return {
        ...
        "situacao_descricao": contratacao.situacao_descricao,
        "beneficio_mpe": contratacao.beneficio_mpe,
        "cota_reservada": contratacao.cota_reservada,
        "srp": contratacao.srp,
        "criterio_julgamento": contratacao.criterio_julgamento,
        "modo_disputa": contratacao.modo_disputa,
        "link_participacao": contratacao.link_sistema_origem,
        "link_edital": contratacao.link_edital,
        "sinal": sinal,
